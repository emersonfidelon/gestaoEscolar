@extends('layouts.app', ['page' => __('Editar aluno'), 'pageSlug' => 'alunos'])
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Editar aluno') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('aluno.update', $aluno) }}" autocomplete="off">
                            @csrf
                            @method('put')
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('nome') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="nome" id="input-nome" 
                                        ...
                                        placeholder="{{ __('Nome Completo') }}" value="{{ old('nome', $aluno->nome) }}" required 
                                    autofocus>
                                ...
                                <div class="form-group{{ $errors->has('cpf') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="cpf" id="input-cpf" 
                                        ...
                                        placeholder="{{ __('CPF') }}" value="{{ old('cpf', $aluno->cpf) }}" 
                                        maxlength="11"
                                        required
                                        >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('data_nascimento') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="data_nascimento" id="input-data_nascimento" 
                                                ...
                                                placeholder="{{ __('dd/mm/aaaa') }}" value="{{ old('data_nascimento', $aluno->data_nascimento) }}" 
                                                required
                                                >
                                ...
                                <div class="form-group{{ $errors->has('rg') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="rg" id="input-rg" 
                                        ...
                                        placeholder="{{ __('RG') }}" value="{{ old('rg', $aluno->rg) }}" 
                                        >
                                ...
                                <div class="form-group{{ $errors->has('certidao') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="certidao" id="input-certidao" 
                                        ...
                                        placeholder="{{ __('Certidão de Nascimento') }}" value="{{ old('certidao', $aluno->certidao) }}" 
                                        >
                                ...
                                <div class="form-group{{ $errors->has('sus') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="sus" id="input-sus" 
                                        ...
                                        placeholder="{{ __('Cartão do SUS') }}" value="{{ old('sus', $aluno->sus) }}" 
                                        required>
                                ...
                                <div class="form-group{{ $errors->has('plano_saude') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="plano_saude" id="input-plano_saude" 
                                        ...
                                        placeholder="{{ __('Nº cartão do plano de saúde') }}" value="{{ old('plano_saude', $aluno->plano_saude) }}" >
                                ...
                                <div class="form-group{{ $errors->has('hospital_emergencia') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="hospital_emergencia" id="input-hospital_emergencia" 
                                        ...
                                        placeholder="{{ __('Em caso de urgência e emergência em que hospital levar?') }}" value="{{ old('hospital_emergencia', $aluno->hospital_emergencia) }}" 
                                        required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="mae" id="input-mae" 
                                                ...
                                                placeholder="{{ __('Nome da mãe') }}" value="{{ old('mae', $aluno->mae) }}" 
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="cpf_mae" id="input-cpf_mae" 
                                                ...
                                                placeholder="{{ __('CPF da mãe') }}" value="{{ old('cpf_mae', $aluno->cpf_mae) }}" 
                                                maxlength="11"
                                                required>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="telefone_mae" id="input-telefone_mae" 
                                                ...
                                                placeholder="{{ __('Telefone da mãe') }}" value="{{ old('telefone_mae', $aluno->telefone_mae) }}" 
                                                required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="pai" id="input-pai" 
                                                ...
                                                placeholder="{{ __('Nome do pai') }}" value="{{ old('pai', $aluno->pai) }}" 
                                                >
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="cpf_pai" id="input-cpf_pai" 
                                                ...
                                                placeholder="{{ __('CPF do pai') }}" value="{{ old('cpf_pai', $aluno->cpf_pai) }}" >
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="telefone_pai" id="input-telefone_pai" 
                                                ...
                                                placeholder="{{ __('Telefone do pai') }}" value="{{ old('telefone_pai', $aluno->telefone_pai) }}" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="responsavel" id="input-responsavel" 
                                                ...
                                                placeholder="{{ __('Nome do responsável') }}" value="{{ old('responsavel', $aluno->responsavel) }}" 
                                                >
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="cpf_responsavel" id="input-cpf_responsavel" 
                                                ...
                                                placeholder="{{ __('CPF do responsavel') }}" value="{{ old('cpf_responsavel', $aluno->cpf_responsavel) }}" >
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="telefone_responsavel" id="input-telefone_responsavel" 
                                                ...
                                                placeholder="{{ __('Telefone do responsavel') }}" value="{{ old('telefone_responsavel', $aluno->telefone_responsavel) }}" >
                                ...
                                <div class="form-group{{ $errors->has('cep') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="cep" id="input-cep" 
                                        ...
                                        placeholder="{{ __('CEP') }}" value="{{ old('cep', $aluno->cep) }}" 
                                        required
                                        >
                                ...
                                <div class="form-group{{ $errors->has('logradouro') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="logradouro" id="input-logradouro" 
                                        ...
                                        placeholder="{{ __('Logradouro') }}" value="{{ old('logradouro', $aluno->logradouro) }}" 
                                        required
                                        >
                                ...
                                <div class="form-group{{ $errors->has('bairro') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="bairro" id="input-bairro" 
                                        ...
                                        placeholder="{{ __('Bairro') }}" value="{{ old('bairro', $aluno->bairro) }}" 
                                        required
                                        >
                                ...
                                <div class="form-group{{ $errors->has('cidade') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="cidade" id="input-cidade" 
                                        ...
                                        placeholder="{{ __('Cidade') }}*" value="{{ old('cidade', $aluno->cidade) }}" 
                                        required
                                        >
                                ...
                                <div class="form-group{{ $errors->has('estado') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="estado" id="input-estado" 
                                        ...
                                        placeholder="{{ __('Estado') }}*" value="{{ old('estado', $aluno->estado) }}" 
                                        required
                                        >
                                ...
                                <div class="form-group{{ $errors->has('observacao') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea type="text" name="observacao" id="input-observacao" 
                                        ...
                                        >
                                        {{ old('observacao', $aluno->observacao) }}
                                        </textarea>
