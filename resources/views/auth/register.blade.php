        ...
        <div class="col-md-5 ml-auto">
            <div class="info-area info-horizontal mt-5">
                ...
                <div class="description">
                    <h3 class="info-title">{{ _('Gestão da escola') }}</h3>
                    <p class="description">
                        {{ _('O sistema foi pensado para que seja possível gerenciar os principais departamentos da escola, turmas, séries, alunos, lançameto de conteúdo, cadastro de pais e muito mais.') }}
                    </p>
                </div>
            </div>
            <div class="info-area info-horizontal">
                ...
                <div class="description">
                    <h3 class="info-title">{{ _('Comunicação com os pais') }}</h3>
                    <p class="description">
                        {{ _('Pais podem acompanhar o conteúdo ministrado a seus filhos no dia a dia, além de enviar e receber mensagens.') }}
                    </p>
                </div>
            </div>
            <div class="info-area info-horizontal">
                ...
                <div class="description">
                    <h3 class="info-title">{{ _('Acompanhamento das aulas') }}</h3>
                    <p class="description">
                        {{ _('Professores podem lançar diariamente os conteúdos m,inistrados em sala de aula, mantendo pais e escola informados em tempo real.') }}
                    </p>
                </div>
            </div>
        </div>
                ...
                <form class="form" method="post" action="{{ route('register') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="password_confirmation" class="form-control" placeholder="{{ _('Confirmação de senha') }}">
                        </div>
